...
module.exports = function (grammar) {
    ...
    let decnum = function (chars, beg, len) {
        let num = 0;
    ...
    let binnum = function (chars, beg, len) {
        let num = 0;
        for (let i = beg; i < beg + len; i += 1) {
    ...
    let hexnum = function (chars, beg, len) {
        let num = 0;
        for (let i = beg; i < beg + len; i += 1) {
            let digit = chars[i];
  ...
  */
                            ...
                            if (nameObj !== -1) {
                                ...
                                data.errors.push({
                                    ...
                                    msg:
                                        "Back reference name '" +
                                        op.index.name +
                                        "' refers to undefined rule or unamed UDT.",
                                });
                                op.index = -1;
                            }
                        }
    ...
    function semUdtEmpty(state, chars, phraseIndex, phraseCount, data) {
        ...
        if (state == id.SEM_PRE) {
            ...
            let name = apglib.utils.charsToString(chars, phraseIndex, phraseCount);
    ...
    function semTlsString(state, chars, phraseIndex, phraseCount, data) {
        ...
        if (state == id.SEM_PRE) {
            ...
            if (data.tlscase) {
                let str = chars.slice(phraseIndex, phraseIndex + phraseCount);
