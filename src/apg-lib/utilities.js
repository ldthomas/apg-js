...
let getBounds = function (length, beg, len) {
    let end;
    while (true) {
        if (length <= 0) {
            beg = 0;
...
exports.htmlToPage = function (html, title) {
    let thisFileName = "utilities.js: ";
    let emitCss = require("./emitcss.js");
...
exports.charsToDec = function (chars, beg, len) {
    ...
    let bounds = getBounds(chars.length, beg, len);
...
exports.stringToAsciiHtml = function (str) {
    let chars = converter.decode("STRING", str);
    //  let chars = this.stringToChars(str);
