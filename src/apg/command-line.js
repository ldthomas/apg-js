...
module.exports = function (args) {
    ...
    let VERSIONS = "-v";
    let DISPLAY_RULES = "--display-rules";
    let DISPLAY_RULE_DEPENDENCIES = "--display-rule-dependencies";
    let DISPLAY_ATTRIBUTES = "--display-attributes";
    let INL = "--in";
    let INS = "-i";
    let OUTL = "--out";
    let OUTS = "-o";
    ...
    try {
        ...
        if (config.outFilename) {
            let info = path.parse(config.outFilename);
            if (info.ext !== "js") {
